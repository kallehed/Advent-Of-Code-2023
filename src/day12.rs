...
pub fn day12_1() {
    let s = std::fs::read_to_string("src/day12.txt")
        .unwrap()
        .into_bytes();
...
pub fn day12_2() {
    ...
    fn check_correct(
        ...
        loop {
            ...
            let can_fill_here = string
                .iter()
                .take(my_len as usize)
                .all(|&x| x == b'#' || x == b'?');
